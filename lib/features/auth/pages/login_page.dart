...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _sendLink() async {
    ...
    try {
      ...
      if (mounted) context.go('/admin/link-sent?email=${Uri.encodeComponent(email)}');
    } catch (e) {
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const Text('Entre ton email pour recevoir un lien de connexion.', style: TextStyle(color: AdminColors.textSecondary, fontSize: 14, height: 1.5)),
