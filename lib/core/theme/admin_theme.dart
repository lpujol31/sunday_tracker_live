...
class AdminColors {
  ...
  static const accentDim    = Color(0x2600E5A0);
  static const textPrimary  = Color(0xFFE8EAF0);
  static const textSecondary= Color(0xFF6B7280);
  static const danger       = Color(0xFFEF4444);
  static const dangerDim    = Color(0x20EF4444);
...
ThemeData buildAdminTheme() {
  return ThemeData(
    ...
    textTheme: const TextTheme(
      headlineMedium: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: AdminColors.textPrimary, letterSpacing: -0.5),
      titleMedium:   TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: AdminColors.textPrimary),
      bodyMedium:    TextStyle(fontSize: 13, color: AdminColors.textSecondary, height: 1.5),
      labelSmall:    TextStyle(fontSize: 11, color: AdminColors.textSecondary, letterSpacing: 0.8),
    ),
    inputDecorationTheme: InputDecorationTheme(
      ...
      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(8), borderSide: const BorderSide(color: AdminColors.accent, width: 1.5)),
